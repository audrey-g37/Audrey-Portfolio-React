	...
	return (
		<section>
			...
			<ul className='directions'>
				<li>*Click an image to open the project repository.</li>
				<li>*Click the box with the project title to see it in action!</li>
			</ul>
			<Container fluid id='work'>
				<Row id='project-body'>
					...
					<Col className='sample'>
						...
						<p className='project-description'>
							Generate a random password after answering prompts about criteria, such
							as password length and types of characters to include.
						</p>
						<a
							className='in-action-link'
					...
					<Col className='sample'>
						...
						<p className='project-description'>
							A command-line application where a user can add and edit employees. The
							user can store their salaries, their 'manager,' their position title,
							etc.
						</p>
						<a
							className='in-action-link'
					...
					<Col className='sample'>
						...
						<p className='project-description'>
							A command-line application where the user can select the employee's
							position and then can type in characteristics, like an office number,
							email address, etc. The employee's characteristics are displayed on an
							employee card. Cards are rendered, for each employee created, to an html
					...
					<Col className='sample'>
						...
						<p className='project-description'>
							A command-line application where the user can make choices or type words
							as input that will be generated into a README.md file.
						</p>
						<a
							className='in-action-link'
